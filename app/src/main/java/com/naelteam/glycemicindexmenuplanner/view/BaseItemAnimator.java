...
public abstract class BaseItemAnimator extends RecyclerView.ItemAnimator {
    ...
    protected ItemAnimatorFinishedListener mAnimationsFinishedListener;
    ...
    public void setItemAnimatorFinishedListener(ItemAnimatorFinishedListener animationsFinishedListener){
        mAnimationsFinishedListener = animationsFinishedListener;
    }
    ...
    private void preAnimateRemove(final RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof AnimatorViewHolder) {
            ((AnimatorViewHolder) holder).preAnimateRemoveImpl();
        } else {
    ...
    private void preAnimateAdd(final RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof AnimatorViewHolder) {
            ((AnimatorViewHolder) holder).preAnimateAddImpl();
        } else {
    ...
    private void doAnimateAdd(final RecyclerView.ViewHolder holder) {
        if (holder instanceof AnimatorViewHolder) {
            ((AnimatorViewHolder) holder).animateAddImpl(new DefaultAddVpaListener(holder));
        } else {
    ...
    private void dispatchFinishedWhenDone() {
        if (!isRunning()) {
            ...
            Log.d("", "dispatchFinishedWhenDone - ");
        }
    }
    ...
    public void endAnimations() {
        ...
        Log.d("", "endAnimations - dispatchAnimationsFinished");
        dispatchAnimationsFinished();
    ...
    protected class DefaultAddVpaListener extends VpaListenerAdapter {
        ...
        public void onAnimationStart(View view) {
            ...
            // add listener on all animations finished
            // necessary to set it when anim is running for further process
            if (mAnimationsFinishedListener != null){
                isRunning(mAnimationsFinishedListener);
            }
    ...
    protected class DefaultRemoveVpaListener extends VpaListenerAdapter {
        ...
        public void onAnimationEnd(View view) {
            ...
            dispatchFinishedWhenDone();
            Log.d("DefaultRemoveVpaListen", "dispatchFinishedWhenDone - ");
        }
    }
}
